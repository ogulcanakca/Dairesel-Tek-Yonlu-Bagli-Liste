...
public:
    ...
    //nesnenin const referans olarak verildiði fonksiyonlarda
    //sadece const olarak tanýmlanmýþ fonksiyonlar çaðrýlabilir
    //operator << fonksiyonu içerisinde listenin sadece aþaðýdaki fonksiyonu 
    //çaðrýlabilir. Çünkü sadece bu fonksiyon const.
